...
<step n="4" goal="Auto-triage findings by effort, user chooses handling" tag="triage">
  ...
  <action>For each finding from Step 3, classify effort:
    ...
    - Missing integration test infrastructure (emulator setup, fixture system, new test patterns)
    - Multiple untested integration seams across a pipeline
  </action>
