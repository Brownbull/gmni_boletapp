...
`GruposView.tsx` is currently **921 lines** (was 788 lines when this story was created), significantly exceeding the 400-line guideline from the codebase conventions.

> **Updated 2026-02-04:** File grew from 788 to 921 lines due to Story 14d-v2-1-11c (transaction sharing toggle handler). Lines 654-782 contain dialog rendering JSX that can be cleanly extracted:
