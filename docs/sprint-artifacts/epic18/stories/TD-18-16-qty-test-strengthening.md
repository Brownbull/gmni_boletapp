...
1. [ ] Strengthen AC-8 assertion: change spy to return derived values, assert onSave receives items with correct unitPrice
2. [ ] Add qty=undefined test case to EditViewItemsSection.qty.test.tsx grouped view section
