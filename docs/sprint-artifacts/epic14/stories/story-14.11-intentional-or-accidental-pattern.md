...
2. **Non-judgmental language** - "Fue intencional" / "No me había dado cuenta"
...
| "Bad spending habit" | "¿Fue intencional?" |
...
interface IntentionalPromptProps {
  ...
  context: string;  // e.g., "Restaurantes subió 45% esta semana"
...
```
[Insight Generation] → [Pattern Detection] → [THIS STORY: Intentional Prompt] → [User Response] → [Profile Learning]
```
