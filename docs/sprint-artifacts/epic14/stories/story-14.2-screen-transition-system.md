...
├── AnimationContext.tsx    # From 14.1
├── PageTransition.tsx      # NEW - Screen transitions
├── TransitionChild.tsx     # NEW - Staggered child wrapper
├── useBreathing.ts         # From 14.1
├── constants.ts            # From 14.1
└── index.ts
```
...
```
[14.1 Animation Framework] → [THIS STORY: Screen Transitions] → [All Views, Navigation UX]
```
