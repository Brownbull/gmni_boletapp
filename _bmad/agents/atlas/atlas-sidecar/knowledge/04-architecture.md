...
| ADR-015 | Client-Side Insight Engine | No Cloud Functions dependency for insights | Planned (Epic 10) |
| ADR-016 | Hybrid Insight Storage | Local-first with Firestore backup | Planned (Epic 10) |
| ADR-017 | Phase-Based Priority | Different insights for cold-start vs data-rich | Planned (Epic 10) |
