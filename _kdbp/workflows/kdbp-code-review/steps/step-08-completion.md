...
<step n="7" goal="Cost tracking, E2E analysis, and story status update" tag="completion">
  ...
  <output>**ECC Code Review Complete!**
    ...
    **Next Steps:**
    ...
    {{#if files_to_review match v5-e2e-awareness Test Registry triggers}}- **V5 E2E Gate:** {{matched_tests_with_tier_and_cost}} — load `skills/v5-e2e-awareness.md` for full registry{{/if}}
