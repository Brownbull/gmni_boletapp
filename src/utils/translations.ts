export const TRANSLATIONS = {
    en: {
        ...
        scanFirstReceipt: "Scan your first receipt to get started",
        ...
        // Story 14d-v2-1-6d: Transaction Sharing Opt-In Dialog
        ...
        recommended: "Default",
        // Story 14d-v2-1-6d: Invitation Error View
        ...
        // CreateGroupDialog translations
        groupName: "Group Name",
        groupNamePlaceholder: "e.g., 🏠 Home Expenses",
        transactionSharing: "Transaction Sharing",
        transactionSharingDescription: "When enabled, members can choose to share their individual transaction details with the group. Statistics are always shared.",
        create: "Create",
        creating: "Creating...",
        ...
        discard: "Discard",
        groupLimitReached: "You've reached the maximum of {max} groups",
        groupLimitTooltip: "Limit of {max} groups reached. Leave a group to create a new one.",
        createGroupError: "Error creating group",
        retry: "Retry",
        // EditGroupDialog translations - Story 14d-v2-1-7g
        editGroup: "Edit Group",
        editGroupTitle: "Edit Group",
        groupUpdatedSuccess: "Group updated",
        groupUpdateError: "Error updating group",
        updateGroup: "Update",
        updating: "Updating...",
        ...
        // InviteMembersDialog translations - Story 14d-v2-1-5c
        inviteMembers: "Invite Members",
        inviteMembersDescription: "Invite others to join \"{groupName}\"",
        ...
        errorCannotTransferToSelfTitle: "Cannot Transfer",
        errorTargetNotMemberTitle: "User Not in Group",
        ...
        errorGroupNotFoundMessage: "This group no longer exists or you don't have access.",
        errorNotMemberMessage: "You're not a member of this group.",
        errorNotOwnerMessage: "Only the group owner can perform this action.",
        errorCannotTransferToSelfMessage: "You can't transfer ownership to yourself.",
        errorTargetNotMemberMessage: "This user is not a member of the group.",
        errorCodeNotFoundMessage: "This invite code doesn't exist. Check the code and try again.",
        errorCodeExpiredMessage: "This invite code has expired. Ask the group owner for a new link.",
        ...
        selectMemberToTransfer: "Select new owner",
        // Story 14d-v2-1-7d: MemberSelectorDialog
    ...
    es: {
        ...
        scanFirstReceipt: "Escanea tu primer recibo para comenzar",
        ...
        join: "Unirme",
        joining: "Uniéndose...",
        invitedToJoinMessage: "{name} te invitó a unirte a este grupo.",
        transactionSharingLabel: "Compartir Transacciones",
        reviewAndJoin: "Revisar y Unirse",
        loadingGroup: "Cargando grupo...",
        // Story 14d-v2-1-6d: Transaction Sharing Opt-In Dialog
        groupAllowsTransactionSharing: '"{group}" permite compartir transacciones',
        shareMyTransactionsDescription: "¿Te gustaría compartir los detalles de tus transacciones con los miembros del grupo?",
        statisticsAlwaysShared: "Tus totales de gasto siempre serán visibles en las estadísticas del grupo.",
        yesShareTransactions: "Sí, compartir mis transacciones",
        yesShareTransactionsDesc: "Los miembros podrán ver tus transacciones individuales",
        noJustStatistics: "No, solo estadísticas",
        noJustStatisticsDesc: "Solo se comparten tus totales, no los detalles",
        privacyNoteOptIn: "Puedes cambiar esto más tarde en la configuración del grupo.",
        recommended: "Predeterminado",
        // Story 14d-v2-1-6d: Invitation Error View
        invalidInvitation: "Invitación Inválida",
        invalidInviteLinkMessage: "Este enlace de invitación es inválido o ha expirado.",
        askForNewInvite: "Por favor, solicita un nuevo enlace de invitación al dueño del grupo.",
        invitationExpiredTitle: "Invitación Expirada",
        invitationExpiredMessage: "Esta invitación ha expirado.",
        invitationAlreadyUsed: "Invitación Ya Usada",
        invitationAlreadyUsedMessage: "Esta invitación ya fue procesada.",
        checkYourGroups: "Revisa tus grupos para ver si ya eres miembro.",
        alreadyMemberTitle: "Ya eres Miembro",
        alreadyMemberMessage: "Ya eres miembro de este grupo.",
        viewGroupInSettings: "Puedes ver el grupo en la configuración de Grupos.",
        groupFullTitle: "Grupo Lleno",
        groupFullMessage: "Este grupo ha alcanzado el número máximo de miembros.",
        contactGroupOwner: "Contacta al dueño del grupo para más información.",
        invitationNetworkError: "Error de Conexión",
        networkErrorMessage: "No se pudo verificar la invitación. Verifica tu conexión a internet.",
        errorOccurred: "Ocurrió un Error",
        unknownErrorMessage: "Algo salió mal al procesar la invitación.",
        ...
        deleteGroupWarning: "Esto eliminará permanentemente el grupo y todos los datos compartidos",
        ...
        confirmDeletePlaceholder: "Escribe el nombre del grupo aquí",
        deleteGroupError: "Error al eliminar el grupo. Por favor, intenta de nuevo.",
        groupDeletedSuccess: "Grupo \"{name}\" eliminado",
        // Note: 'deleting' key already exists above for batch operations
        personal: "Personal",
        ...
        sharedGroupsDescription: "Comparte gastos con familia o compañeros",
        createGroup: "Crear Grupo",
        noGroupsYet: "Aún no tienes grupos",
        noGroupsDescription: "Crea tu primer grupo para empezar a compartir gastos",
        groupCreatedSuccess: "Grupo creado exitosamente",
        // CreateGroupDialog translations
        groupName: "Nombre del Grupo",
        groupNamePlaceholder: "ej., 🏠 Gastos del Hogar",
        transactionSharing: "Compartir Transacciones",
        transactionSharingDescription: "Cuando está habilitado, los miembros pueden elegir compartir sus transacciones individuales con el grupo. Las estadísticas siempre se comparten.",
        create: "Crear",
        creating: "Creando...",
        discardGroupCreation: "¿Descartar creación del grupo?",
        discardGroupBody: "Tienes cambios sin guardar. ¿Estás seguro de que quieres descartar?",
        keepEditing: "Seguir Editando",
        discard: "Descartar",
        groupLimitReached: "Has alcanzado el máximo de {max} grupos",
        groupLimitTooltip: "Límite de {max} grupos alcanzado. Sal de un grupo para crear uno nuevo.",
        ...
        groupUpdateError: "Error al actualizar el grupo",
        updateGroup: "Actualizar",
        updating: "Actualizando...",
        discardGroupEdit: "¿Descartar cambios?",
        discardGroupEditBody: "Tienes cambios sin guardar. ¿Estás seguro de que quieres descartar?",
        iconLabel: "Icono",
        colorLabel: "Color",
        ...
        errorInvitationNotFoundTitle: "Invitación No Encontrada",
        errorAlreadyInvitedTitle: "Ya Invitado",
        errorGroupFullTitle: "Grupo Lleno",
        errorAlreadyMemberTitle: "Ya Eres Miembro",
        errorNotMemberTitle: "No Eres Miembro",
        errorNotOwnerTitle: "Permiso Denegado",
        errorCannotTransferToSelfTitle: "No Se Puede Transferir",
        errorTargetNotMemberTitle: "Usuario No Está en el Grupo",
        errorCodeNotFoundTitle: "Código Inválido",
        errorCodeExpiredTitle: "Código Expirado",
        errorNetworkTitle: "Error de Conexión",
        errorStorageQuotaTitle: "Almacenamiento Limitado",
        errorPermissionDeniedTitle: "Acceso Denegado",
        errorUnknownTitle: "Algo Salió Mal",
        // Error messages
        errorUserNotFoundMessage: "No se encontró un usuario con este correo. Deben registrarse primero.",
        errorInvitationExpiredMessage: "Esta invitación ha expirado. Pídele al dueño del grupo que envíe una nueva.",
        errorAlreadyInvitedMessage: "Ya se envió una invitación a este correo.",
        errorGroupFullMessage: "Este grupo ha alcanzado el máximo de 10 miembros.",
        errorGroupNotFoundMessage: "Este grupo ya no existe o no tienes acceso.",
        errorNotMemberMessage: "No eres miembro de este grupo.",
        errorNotOwnerMessage: "Solo el dueño del grupo puede realizar esta acción.",
        errorCannotTransferToSelfMessage: "No puedes transferir la propiedad a ti mismo.",
        errorTargetNotMemberMessage: "Este usuario no es miembro del grupo.",
        errorCodeNotFoundMessage: "Este código de invitación no existe. Verifica el código e intenta de nuevo.",
        errorCodeExpiredMessage: "Este código de invitación ha expirado. Pídele al dueño del grupo un nuevo enlace.",
        errorNetworkMessage: "No se puede conectar. Verifica tu conexión a internet e intenta de nuevo.",
        ...
        errorBoundaryMessage: "Esta sección no pudo cargar. Intenta actualizar o vuelve a la pantalla principal.",
        errorDetails: "Detalles técnicos",
        // Story 14d-v2-1-7d AC #5: View Mode Auto-Switch on Leave
        leftGroup: 'Saliste de "{groupName}"',
        leftGroupSwitchedToPersonal: 'Saliste de "{groupName}". Viendo datos personales.',
        viewingPersonalData: "Viendo datos personales",
        errorLeavingGroup: "Error al salir del grupo",
        errorTransferringOwnership: "Error al transferir propiedad",
        ownershipTransferred: "Propiedad transferida a {name}",
        selectMemberToTransfer: "Seleccionar nuevo dueño",
        // Story 14d-v2-1-7d: MemberSelectorDialog
