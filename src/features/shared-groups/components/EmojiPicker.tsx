    ...
    return (
        <>
            ...
            <button
                ...
                disabled={disabled}
                className={`${sizeClasses[size]} ${fontSizeClasses[size]} rounded-full flex items-center justify-center shrink-0 aspect-square transition-all hover:scale-105 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500`}
                style={{
