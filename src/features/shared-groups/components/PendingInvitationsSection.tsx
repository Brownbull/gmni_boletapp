 ...
 *
 * Data-testid attributes (Story 14d-v2-1-6c-1 Task 8.5):
 * - pending-invitations-list: Container element
 * - invitation-item-{id}: Each invitation card
 * - accept-btn: Accept invitation button
 * - decline-btn: Decline invitation button
 */
...
export interface PendingInvitationsSectionProps {
    ...
    /** Whether to show the section header (default: true). Set to false when used within a view that has its own header. */
    showHeader?: boolean;
}
...
export const PendingInvitationsSection: React.FC<PendingInvitationsSectionProps> = ({
    ...
    // lang used for future localization
    void lang;
    ...
    return (
        ...
        >
            {/* Section Header - conditionally rendered to avoid duplication when used in PendingInvitationsView */}
            {showHeader && (
                <div className="flex items-center gap-3 mb-4">
                    ...
                    >
                        <Mail className="w-5 h-5" style={{ color: 'var(--notification-amber-icon, #d97706)' }} />
                    </div>
