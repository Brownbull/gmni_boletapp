...
export const GroupMembersManager: React.FC<GroupMembersManagerProps> = ({
    ...
    // Note: DeleteGroupDialog.onConfirm no longer passes removeTransactionTags parameter
    // Default to true (remove transaction tags when deleting group)
    const handleConfirmDelete = useCallback(async () => {
        await onDeleteGroup(group.id!, true);
