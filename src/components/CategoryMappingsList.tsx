 ...
 *
 * Displays user's learned category mappings with delete functionality.
...
import { Trash2, BookMarked, X } from 'lucide-react'
 ...
 * with the ability to delete individual mappings.
 *
 * Features:
...
export const CategoryMappingsList: React.FC<CategoryMappingsListProps> = ({
  ...
  const handleKeyDown = (e: React.KeyboardEvent, mapping: CategoryMapping) => {
