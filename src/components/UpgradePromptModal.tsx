 ...
 *
 * Accessible modal that prompts non-subscribers to upgrade for premium features.
 * Implements WCAG 2.1 Level AA compliance with proper focus trap and keyboard handling.
 *
 * @module UpgradePromptModal
 * @see Story 5.5: Premium Statistics Export & Upgrade Prompt
 */
...
/**
 * Props for the UpgradePromptModal component
 */
export interface UpgradePromptModalProps {
  ...
  onClose: () => void;
  /** Callback when user clicks the upgrade CTA */
  onUpgrade: () => void;
...
/**
 * Accessible upgrade prompt modal for premium feature gating.
 *
 * Features:
 ...
 *
 * @param props - UpgradePromptModalProps
...
export const UpgradePromptModal: React.FC<UpgradePromptModalProps> = ({
  ...
  // Handle Escape key to close modal (AC#6, AC#7)
  useEffect(() => {
    if (!isOpen) return;
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={`relative w-full max-w-md rounded-2xl ${cardBg} ${textColor} shadow-xl`}
      ...
      >
        ...
        <div className="p-6 text-center">
          ...
          <div className="flex flex-col gap-3">
            <button
              onClick={onUpgrade}
              className="w-full py-3 px-4 rounded-xl bg-gradient-to-r from-yellow-400 to-orange-500 text-white font-semibold hover:from-yellow-500 hover:to-orange-600 transition-all shadow-md"
            >
              {t('upgradeCta')}
            </button>
