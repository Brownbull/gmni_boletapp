/**
 * SubcategoryLearningPrompt Component
 *
 * Accessible modal that prompts users to save a subcategory preference for future use.
 * Implements WCAG 2.1 Level AA compliance with proper focus trap and keyboard handling.
 *
 * @module SubcategoryLearningPrompt
 ...
 */
export interface SubcategoryItemToLearn {
  itemName: string
  newSubcategory: string
}

/**
 * Props for the SubcategoryLearningPrompt component
 */
export interface SubcategoryLearningPromptProps {
...
/**
 * Accessible subcategory learning prompt modal.
 *
 * Features:
 ...
 */
export const SubcategoryLearningPrompt: React.FC<SubcategoryLearningPromptProps> = ({
  isOpen,
  items,
  onConfirm,
  onClose,
  ...
  return (
    ...
    >
      ...
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="learn-subcategory-modal-title"
        aria-describedby="learn-subcategory-modal-description"
      ...
      >
        ...
        <div className="p-6 text-center">
          {/* Icon with green gradient accent (different from category blue) */}
          <div
          ...
          {/* Title */}
          <h2
            id="learn-subcategory-modal-title"
            className="text-xl font-bold mb-2"
            style={{ color: 'var(--primary)' }}
          >
            {t('learnSubcategoryTitle')}
          </h2>

          {/* Description - show list of items to learn */}
          <div
            id="learn-subcategory-modal-description"
            className="mb-6"
            style={{ color: 'var(--secondary)' }}
          >
            <p className="mb-3">{t('learnSubcategoryMessage')}</p>
            <ul className="text-left space-y-2">
              {items.map((item, index) => (
                ...
                >
                  ...
                  <span className="font-semibold text-green-600">{item.newSubcategory}</span>
                </li>
              ))}
            </ul>
          </div>
