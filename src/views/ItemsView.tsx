 ...
 * - Año | Trimestre | Mes | Semana | Día pills
...
interface ItemsViewProps {
    /** All transactions to extract items from */
    ...
    /** Story 14.31 Session 2: Authenticated user ID for groups */
    userId?: string | null;
    /** Story 14.31 Session 2: App ID for Firestore path */
    appId?: string;
...
export const ItemsView: React.FC<ItemsViewProps> = ({
    ...
    const filteredItems = useMemo(() => {
        ...
        if (drillDownPath) {
            ...
            // Item category filter from context (group = item categories like "Carnes", "Lácteos")
            // Story 14.13b: Use normalizeItemCategory to handle translated category names
