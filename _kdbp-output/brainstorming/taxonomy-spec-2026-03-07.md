# BoletApp Category Taxonomy Spec v1.0

**Date:** 2026-03-07
**Source:** Brainstorming session (Epic 17 prep)
**Status:** APPROVED — ready for Story 17-1 implementation
**Behavior:** boletapp-dev v1.0.0
...
- No fixed mapping between them — you can buy "Medicamentos" at a "Supermercado"
- L1 groups L2; L3 groups L4 — they are independent dimensions
...
| Household | HomeEssentials | Artículos del Hogar | Clarified (+ Furnishings merged) |
